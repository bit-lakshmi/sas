...
function initToast() {
    ...
    addCSSRule(sheet,
        ...
        'height: 30px;' +
        'border-radius: 50%;' +
        'background: #FE715B url("http://sas.com/assets/images/warn.png") no-repeat center;' +
    ...
    addCSSRule(sheet,
        '.success .error_inner',
        'background-image: url("http://sas.com/assets/images/done.png");'
    );
    ...
    addCSSRule(sheet,
        '.loader .error_inner',
        'background-image: url("http://sas.com/assets/images/load.png");'
    );
